...
<div class="login-box">
    <div class="login-logo">
        <a href="index.php"><b>Designer Login</b></a>
    </div>
    <!-- /.login-logo -->
    <div class="card">
        <div class="card-body login-card-body">
            ...
            <p class="mb-0">
                <a href="Designer_signUp.php" class="text-center">Register a new designer</a>
            </p>
...
if (!empty($_POST) && isset($_POST['submit'])) {
    ...
    $password = isset($_POST['password']) ? $_POST['password'] :'';
       //process in designer table

    $is_verified = verify_designer_login($emailAdress, $password, $conn);
    if ($is_verified) {
